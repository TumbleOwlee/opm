...
# draw RDA biplots describing Phenotype MicroArray data. An advantage of such
...
#' RDA biplot of PM data with BiodiversityR
#' 
...
#' 
#' @return Object of class "rda", returned invisibly.
#'
custom_rda <- function(x, group = TRUE, circle = scaling == 1,
  ...
  if (group) {
    ...
    # This did not seem to work on an X11 device! PDF was OK.
...
# The following code would create an RDA biplot for the vaas_4 example data.
#
if (FALSE) {
