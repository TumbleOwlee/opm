...
\rcscom{
This section has been largely re-written because it did not really serve as an overview.
The other forthcoming steps and subsections should also be mentioned and linked here.
Johannes, might you have a look?
But see also next TODO entry.
}
...
\rcscom{Lea, is this the correct idea?}
