...
%TODO
% unlikely that we need an introduction
% clearly we do not need the JSS manuscript structure here
...
\subsection[Available plate information]{Available plate information}\label{plateInfo}
...
%TODO
% rather unlikely that we here need the separation between scientifc background and coding
% clearly we do not need the JSS manuscript structure anymore
% please proceed with the code examples, reduce the other stuff
% avoid ALL unnecessary text
...
%TODO
% rather unlikely that we need the separation between scientific background and
% coding; see above

\subsection[Data preparation]{Data preparation}\label{dataPrep}

%TODO move this to first code chunk; see above
...
%TODO
% REMOVE the descriptions of the datasets, replace by reference if necessary.
% All this text has just been copied from the main tutorial -- why for heaven's sake?
% REMEMBER: AVOID ALL REDUNDANCIES!!!!!
...
%TODO
% Remove the description of the aggregation.
% It should be replaced by a reference to the main tutorial, but the description
% of the aggregation isn't even necessary in this file.
% Indeed, all text that follows has just been copied from the main tutorial -- why for heaven's sake?
% REMEMBER: AVOID ALL REDUNDANCIES!!!!!
...
%TODO
% The next section should become the second section, after a simple first section in which
% just opm is loaded.
...
% * move R comments as far as possible to main text
